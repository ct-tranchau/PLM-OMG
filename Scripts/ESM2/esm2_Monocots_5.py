...
best_dev_f1 = 0.0
best_model_path = "/Model/ESM2/esm2_Monocots_5.pt"
...
for loader, name in zip([
    ...
    save_classification_report(labels, preds, f"/Tables/ESM2/classification_report_monocots_5_{name}.csv")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/Figures/ESM2/accuracy_plot_Monocots_5.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/Figures/ESM2/loss_plot_Monocots_5.png")