...
# Filter orthogroups with >100 samples in training split
...
best_dev_f1 = 0.0
best_model_path = "/Model/PROGPT2/protgpt2_Monocots_5.pt"
...
for name, df in test_sets.items():
    ...
    save_path = f"/Tables/PROGPT2/classification_report_test_monocots_5_{name}.csv"
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/Figures/PROGPT2/accuracy_plot_Monocots_5.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/Figures/PROGPT2/loss_plot_Monocots_5.png")