...
best_dev_f1 = 0.0
best_model_path = "/Model/PROBERT/proteinbert_15.pt"
...
for name, df in test_sets.items():
    ...
    save_classification_report(labels, preds, f"/Tables/PROBERT/classification_report_test_15_{name}.csv")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/Figures/PROBERT/accuracy_plot_15.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/Figures/PROBERT/loss_plot_15.png")