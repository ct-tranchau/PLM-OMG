...
epochs = 5
best_dev_f1 = 0.0
best_model_path = "/Model/PROGEN/progen2_Monocots_5.pt"
...
for name, df in test_sets.items():
    ...
    save_classification_report(labels, preds, f"/Tables/PROGEN/classification_report_test_monocots_5_{name}.csv")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/Figures/PROGEN/accuracy_plot_Monocots_5.png")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("/Figures/PROGEN/loss_plot_Monocots_5.png")